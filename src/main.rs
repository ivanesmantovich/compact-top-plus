...
impl State {
    ...
    fn schedule_next_clock_update(&self) {
        let seconds_until_next_minute = 60 - Local::now().second();
        set_timeout(seconds_until_next_minute as f64);
    }
